...
constexpr static MsgId MSG_ID_ON_MD_BID1_ASK1 = 10006;
constexpr static MsgId MSG_ID_ON_MD_LAST_PRICE = 10007;
constexpr static MsgId MSG_ID_ON_MD_DYN_CANDLE = 10008;
...
constexpr static MsgId MSG_ID_ON_STG_STOP = 10057;
constexpr static MsgId MSG_ID_ON_STG_INST_STOP = 10058;
constexpr static MsgId MSG_ID_ON_STG_MANUAL_INTERVENTION = 10060;

constexpr static MsgId MSG_ID_ON_STG_MANUAL_ORDER = 10061;
constexpr static MsgId MSG_ID_ON_STG_MANUAL_ORDER_RET = 10062;
constexpr static MsgId MSG_ID_ON_STG_MANUAL_CANCEL_ORDER = 10063;
constexpr static MsgId MSG_ID_ON_STG_MANUAL_CANCEL_ORDER_RET = 10064;
...
constexpr static MsgId MSG_ID_ON_ALGO_ORDER = 10105;

constexpr static MsgId MSG_ID_ON_MANUAL_ORDER = 10111;
constexpr static MsgId MSG_ID_ON_MANUAL_ORDER_RET = 10112;
constexpr static MsgId MSG_ID_ON_MANUAL_CANCEL_ORDER = 10113;
constexpr static MsgId MSG_ID_ON_MANUAL_CANCEL_ORDER_RET = 10114;

constexpr static MsgId MSG_ID_ON_TEST_ORDER = 10121;
constexpr static MsgId MSG_ID_ON_TEST_CANCEL_ORDER = 10122;

constexpr static MsgId MSG_ID_ON_RISK_CTRL_CONF_CHG = 10131;
constexpr static MsgId MSG_ID_ON_ACCT_INFO_CHG = 10132;

constexpr static MsgId MSG_ID_POS_UPDATE_OF_ALL = 10201;
constexpr static MsgId MSG_ID_POS_SNAPSHOT_OF_ALL = 10202;

constexpr static MsgId MSG_ID_POS_UPDATE_OF_ACCT_ID = 10203;
constexpr static MsgId MSG_ID_POS_SNAPSHOT_OF_ACCT_ID = 10204;

constexpr static MsgId MSG_ID_POS_UPDATE_OF_STG_ID = 10205;
constexpr static MsgId MSG_ID_POS_SNAPSHOT_OF_STG_ID = 10206;

constexpr static MsgId MSG_ID_POS_UPDATE_OF_STG_INST_ID = 10207;
constexpr static MsgId MSG_ID_POS_SNAPSHOT_OF_STG_INST_ID = 10208;

constexpr static MsgId MSG_ID_ASSETS_UPDATE = 10209;
constexpr static MsgId MSG_ID_ASSETS_SNAPSHOT = 10210;
...
inline std::string GetMsgName(MsgId msgId) {
  switch (msgId) {
    ...
    case MSG_ID_ON_MD_LAST_PRICE:
      return "onMDLastPrice";
    case MSG_ID_ON_MD_DYN_CANDLE:
      return "onMDDynCandle";
    ...
    case MSG_ID_ON_STG_MANUAL_ORDER:
      return "onStgManualOrder";
    case MSG_ID_ON_STG_MANUAL_ORDER_RET:
      return "onStgManualOrderRet";
    case MSG_ID_ON_STG_MANUAL_CANCEL_ORDER:
      return "onStgManualCancel";
    case MSG_ID_ON_STG_MANUAL_CANCEL_ORDER_RET:
      return "onStgManualCancelOrderRet";
    ...
    case MSG_ID_ON_MANUAL_ORDER:
      return "onManualOrder";
    case MSG_ID_ON_MANUAL_ORDER_RET:
      return "onManualOrderRet";
    case MSG_ID_ON_MANUAL_CANCEL_ORDER:
      return "onManualCancelOrder";
    case MSG_ID_ON_MANUAL_CANCEL_ORDER_RET:
      return "onManualCancelOrderRet";
    ...
    case MSG_ID_ON_RISK_CTRL_CONF_CHG:
      return "onRiskCtrlConfChg";
    case MSG_ID_ON_ACCT_INFO_CHG:
      return "onAcctInfoChg";

    case MSG_ID_POS_UPDATE_OF_ALL:
      return "posUpdateOfAll";
    case MSG_ID_POS_SNAPSHOT_OF_ALL:
      return "posSnapshotOfAll";
