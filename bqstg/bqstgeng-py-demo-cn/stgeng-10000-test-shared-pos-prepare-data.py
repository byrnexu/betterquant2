...
class StgInstTaskHandler(StgInstTaskHandlerBase):
    ...
    def Test1(self, stg_inst_info):
        ...
        ret_of_order11 = self.stg_eng.order(stg_inst_info, market_code=MarketCode.DCE, symbol_code="c2403", side=Side.Ask, pos_direction=PosDirection.Open, order_price=100, order_size=100, trd_acct_id=100001, close_tday_stg=CloseTDayStg.AllowCloseTDay, algo_id=0, simed_td_info=simed_td_info)
        # fmt: on
    ...
    def Test2(self):
        mylogger.info(f"dailyClosingWork ...")
        self.stg_eng.sync_exec_sql("call uspDailyClosingWork();")
