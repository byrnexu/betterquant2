...
class StgInstTaskHandler(StgInstTaskHandlerBase):
    ...
    def Test3(self, stg_inst_info):
        ...
        ret_of_order34 = self.stg_eng.order(stg_inst_info, market_code=MarketCode.DCE, symbol_code="a2403", side=Side.Ask, pos_direction=PosDirection.Open, order_price=101, order_size=101, trd_acct_id=100001, close_tday_stg=CloseTDayStg.AllowCloseTDay, algo_id=0, simed_td_info=simed_td_info)
        # fmt: on
    ...
    def Test4(self, stg_inst_info):
        ...
        ret_of_order44 = self.stg_eng.order(stg_inst_info, market_code=MarketCode.DCE, symbol_code="a2403", side=Side.Bid, pos_direction=PosDirection.Close, order_price=99, order_size=101, trd_acct_id=100001, close_tday_stg=CloseTDayStg.AllowCloseTDay, algo_id=0, simed_td_info=simed_td_info)
        # fmt: on
