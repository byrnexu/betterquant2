...
class StgInstTaskHandler(StgInstTaskHandlerBase):
    ...
    def on_stg_start(self):
        self.stg_eng.install_stg_inst_timer(
            stg_inst_id=1,
            timer_name="InitBaseFeeInfo",
            exec_at_startup=ExecAtStartup.IsFalse,
            millisec_interval=1000 * 3,
            max_exec_times=1,
        )
        ...
        self.stg_eng.install_stg_inst_timer(
            stg_inst_id=1,
            timer_name="TestOrder1",
            exec_at_startup=ExecAtStartup.IsFalse,
            millisec_interval=1000 * 13,
            max_exec_times=1,
        )
        ...
        self.stg_eng.install_stg_inst_timer(
            stg_inst_id=1,
            timer_name="TestOrder2",
            exec_at_startup=ExecAtStartup.IsFalse,
            millisec_interval=1000 * 16,
            max_exec_times=1,
        )
        ...
        self.stg_eng.install_stg_inst_timer(
            stg_inst_id=1,
            timer_name="TestOrder3",
            exec_at_startup=ExecAtStartup.IsFalse,
            millisec_interval=1000 * 19,
            max_exec_times=1,
        )
        ...
        self.stg_eng.install_stg_inst_timer(
            stg_inst_id=1,
            timer_name="TestOrder4",
            exec_at_startup=ExecAtStartup.IsFalse,
            millisec_interval=1000 * 22,
            max_exec_times=1,
        )
        ...
        self.stg_eng.install_stg_inst_timer(
            stg_inst_id=1,
            timer_name="CheckResult",
            exec_at_startup=ExecAtStartup.IsFalse,
            millisec_interval=1000 * 25,
            max_exec_times=1,
        )
