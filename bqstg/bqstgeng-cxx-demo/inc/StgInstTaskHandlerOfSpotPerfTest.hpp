/*!
 * \file StgInstTaskHandlerOfSpotPerfTest.hpp
 * \project BetterQuant
 *
 * \author byrnexu
 * \date 2022/09/08
...
class StgInstTaskHandlerOfSpotPerfTest : public StgInstTaskHandlerBase {
 public:
  StgInstTaskHandlerOfSpotPerfTest(const StgInstTaskHandlerOfSpotPerfTest&) =
      delete;
  StgInstTaskHandlerOfSpotPerfTest& operator=(
      const StgInstTaskHandlerOfSpotPerfTest&) = delete;
  StgInstTaskHandlerOfSpotPerfTest(const StgInstTaskHandlerOfSpotPerfTest&&) =
      delete;
  StgInstTaskHandlerOfSpotPerfTest& operator=(
      const StgInstTaskHandlerOfSpotPerfTest&&) = delete;
