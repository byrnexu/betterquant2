/*!
 * \file StgInstTaskHandlerOfPerpTest.hpp
 * \project BetterQuant
 *
 * \author byrnexu
 * \date 2022/09/08
...
class StgInstTaskHandlerOfPerpTest : public StgInstTaskHandlerBase {
 public:
  StgInstTaskHandlerOfPerpTest(const StgInstTaskHandlerOfPerpTest&) = delete;
  StgInstTaskHandlerOfPerpTest& operator=(const StgInstTaskHandlerOfPerpTest&) =
      delete;
  StgInstTaskHandlerOfPerpTest(const StgInstTaskHandlerOfPerpTest&&) = delete;
  StgInstTaskHandlerOfPerpTest& operator=(
      const StgInstTaskHandlerOfPerpTest&&) = delete;
