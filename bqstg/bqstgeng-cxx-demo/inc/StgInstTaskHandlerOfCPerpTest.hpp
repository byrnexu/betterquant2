/*!
 * \file StgInstTaskHandlerOfCPerpTest.hpp
 * \project BetterQuant
 *
 * \author byrnexu
 * \date 2022/09/08
...
class StgInstTaskHandlerOfCPerpTest : public StgInstTaskHandlerBase {
 public:
  StgInstTaskHandlerOfCPerpTest(const StgInstTaskHandlerOfCPerpTest&) = delete;
  StgInstTaskHandlerOfCPerpTest& operator=(
      const StgInstTaskHandlerOfCPerpTest&) = delete;
  StgInstTaskHandlerOfCPerpTest(const StgInstTaskHandlerOfCPerpTest&&) = delete;
  StgInstTaskHandlerOfCPerpTest& operator=(
      const StgInstTaskHandlerOfCPerpTest&&) = delete;
