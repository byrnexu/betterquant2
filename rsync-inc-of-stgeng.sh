...
rsync -avzPcR ./bqpub/inc/def/PosOfStgInst.hpp inc/cxx/
...
rsync -avzPcR ./bqpub/inc/def/SymbolCodeIF.hpp inc/cxx/
...
rsync -avzPcR ./bqipc/inc/CommonIPCData.hpp inc/cxx/
