...
sync_plugin() {
  mkdir -p $SOLUTION_ROOT_DIR/bin/plugin/global/
  mkdir -p $SOLUTION_ROOT_DIR/bin/plugin/acctId-trdAcctId/
  rsync -aPc $SOLUTION_ROOT_DIR/bin/plugin/global/*$PROJ_NAME*  \
             $SOLUTION_ROOT_DIR/bin/plugin/global/
  rsync -aPc $SOLUTION_ROOT_DIR/bin/plugin/global/*$PROJ_NAME*  \
             $SOLUTION_ROOT_DIR/bin/plugin/acctId-trdAcctId/
}
